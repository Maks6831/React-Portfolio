...
<div class="isolate bg-white py-24 px-6 sm:py-32 lg:px-8">
  ...
  <div class="mx-auto max-w-2xl text-center">
    <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl" style={{paddingBottom: "20px"}}>Get in Touch</h2>
    <p class="mt-2 text-lg leading-8 text-gray-600">For business inquiries, work oppurtunities etc. please leave your details below and I will get back to you as soon as possible.<br></br> <a href="https://www.linkedin.com/in/muhammad-khan-464b80203" style={styling}>Linkedin</a> <br></br>  <a href="https://github.com/maks6831/" style={styling}>Github</a> <br></br> <a href="mailto: ma.khan6971@gmail.com" style={styling}>Email</a> <br></br> </p>
  </div>
